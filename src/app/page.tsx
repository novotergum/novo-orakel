        ...
        >
          <thead>
            ...
            >
              ...
              <th style={{ padding: "8px 12px", textAlign: "right" }}>Tipps</th>
              <th style={{ padding: "8px 12px", textAlign: "right" }}>Exakt</th>
              <th style={{ padding: "8px 12px", textAlign: "right" }}>Tendenz</th>
              <th style={{ padding: "8px 12px", textAlign: "right" }}>Punkte</th>
            </tr>
          </thead>
          <tbody>
            {board.map((entry, i) => (
              ...
              >
                ...
                <td
                  style={{ padding: "12px", textAlign: "right", color: "#888" }}
                >
                  {entry.tips}
                </td>
                <td
                  style={{ padding: "12px", textAlign: "right", color: "#4ade80" }}
                >
                  {entry.exact}
                </td>
                <td
                  style={{ padding: "12px", textAlign: "right", color: "#fbbf24" }}
                >
                  {entry.tendency}
                </td>
                <td
